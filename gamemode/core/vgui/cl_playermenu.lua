...
function PANEL:Init()
    ...
    -- Add the logo image at the bottom left
    self.logo = vgui.Create("DImage", self)
    self.logo:SetImage("hl2land/Smaller.png")
    self.logo:SetSize(110, 64)  -- Adjust the size as needed
    self.logo:SetPos(10, self:GetTall() - 74)  -- Position it 10px from the left and 10px from the bottom
end
